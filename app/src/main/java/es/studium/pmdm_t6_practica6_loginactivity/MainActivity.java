...
public class MainActivity extends AppCompatActivity{
    ...
    String usuarioCredencial = "Alejandro";
    String ClaveCredencial = "29511125D";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //btn_acceder.setBackgroundResource(R.drawable.boton);
        btn_acceder.setBackgroundColor(0xffffff00);
        btn_acceder.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                if(v.getId() == (R.id.btn_acceder)){
                    //Comprobamos que se haya introducido el usuario y la contraseña
